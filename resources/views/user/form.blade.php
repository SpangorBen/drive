...
<body>
    ...
    <div class="min-h-screen p-6 bg-gray-100 flex items-center justify-center">
        ...
        <div>
            <h2 class="font-semibold text-xl text-gray-600">Hello again dear user</h2>
            <p class="text-gray-500 mb-6">Please complete your registration before making your first reservation</p>
            ...
            <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 lg:grid-cols-3">
                ...
                <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-5">
                    ...
                    <label for="full_name">Little Description</label>
        ...
        <form method="POST" action="{{ route('logout') }}">@csrf
            <button class="md:absolute bottom-0 right-0 p-4 float-right">
                <img src="{{asset('pics/logout.png')}}" alt="LogOut" class="transition-all rounded-full w-14 hover:shadow-sm shadow-lg ring hover:ring-4 ring-gray-400">
            </button>
        </form>
        </div>
    </div>
