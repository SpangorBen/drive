...
Route::middleware(['auth', 'role:user'])->group(function(){
    ...
    Route::post('user/dashboard', [UserController::class, 'searchRoutes'])->name('route.search');
    Route::post('user/dashboard/reserve', [ReservationController::class, 'store'])->name('reservation.store');
    Route::delete('user/dashboard/{reservation}', [ReservationController::class, 'destroy'])->name('reservation.destroy');
});
...
Route::middleware(['auth', 'role:driver'])->group(function(){
    ...
    Route::delete('/driver/routes/{route}', [DriverRouteController::class, 'destroy'])->name('driver.routes.destroy');
